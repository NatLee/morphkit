...
支援三大類轉換：圖片（PNG / JPG / WEBP / BMP / GIF / AVIF → WEBP / PNG / JPG，附品質滑桿）、音訊（MP3 / WAV / OGG / FLAC / M4A / AAC / OPUS 互轉）、影片（MP4 / WEBM / MOV / AVI / MKV → MP4 / WEBM / GIF，或抽出 MP3 音軌）。介面支援深淺色主題與三語系（繁體中文／English／日本語），設定會記憶在 localStorage。
...
- 轉換任務透過計數號誌（counting semaphore）排程，上限為使用者設定的 worker 數
