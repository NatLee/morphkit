...
try {
  ...
  const MANIFEST = {
    ...
    'editors.md': ['src/components/ImageEditor.tsx', 'src/components/GifEditor.tsx', 'src/components/PdfEditor.tsx', 'src/components/PdfPasswordModal.tsx', 'src/components/DocEditor.tsx', 'src/components/ColorPicker.tsx', 'src/styles.css'],
    ...
    'libs.md': ['src/lib/ffmpegClient.ts', 'src/lib/animImage.ts', 'src/lib/pdf.ts', 'src/lib/qpdf.ts', 'src/lib/docs.ts', 'src/lib/imageConvert.ts', 'src/lib/metadata.ts', 'src/lib/formats.ts', 'src/lib/settings.ts', 'src/lib/idb.ts', 'src/lib/wav.ts', 'src/lib/audioEngine.ts', 'src/lib/studioTypes.ts', 'src/lib/useSplitter.ts', 'src/types.ts', 'src/i18n.tsx'],
