...
try {
  ...
  const MANIFEST = {
    ...
    'libs.md': ['src/lib/ffmpegClient.ts', 'src/lib/animImage.ts', 'src/lib/pdf.ts', 'src/lib/qpdf.ts', 'src/lib/docs.ts', 'src/lib/pptx.ts', 'src/lib/qr.ts', 'src/lib/imageConvert.ts', 'src/lib/metadata.ts', 'src/lib/formats.ts', 'src/lib/settings.ts', 'src/lib/idb.ts', 'src/lib/wav.ts', 'src/lib/audioEngine.ts', 'src/lib/studioTypes.ts', 'src/lib/useSplitter.ts', 'src/types.ts', 'src/i18n.tsx'],
