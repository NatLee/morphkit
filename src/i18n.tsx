...
const zh: Dict = {
  ...
  typeGif: 'GIF 專案',
  typeVideo: '影片專案',
  typeAudioDesc: '多軌混音・錄音（BandLab 式）',
  typeImageDesc: '大畫布・圖層編輯（Photoshop 式）',
...
const en: Dict = {
  ...
  typeAudioDesc: 'Multi-track mixing & recording (BandLab-style)',
  typeImageDesc: 'Big canvas with layers (Photoshop-style)',
...
const ja: Dict = {
  ...
  typeGif: 'GIFプロジェクト',
  typeVideo: '動画プロジェクト',
  typeAudioDesc: 'マルチトラックミックスと録音（BandLab風）',
  typeImageDesc: 'キャンバスとレイヤー編集（Photoshop風）',
